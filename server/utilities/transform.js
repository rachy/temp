...
var transform = function (filename, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    var path, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                path = "./assets/full/" + filename + ".jpg";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                err_1 = _a.sent();
                console.log('error at sharp processing: ' + err_1);
                throw err_1;
